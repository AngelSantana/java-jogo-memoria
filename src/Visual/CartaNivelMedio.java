...
public class CartaNivelMedio extends Carta {

    private final String imgFundo = "/Imagens/IMAGEM_FUNDO_80.png"; // Recebe imagem de Plano de fundo
    


    public CartaNivelMedio(String imgF, JLabel Label_pont, JLabel cartasViradas, JMenuItem novojogo) {//Construtor Carta
    ...
    public void capturarCliqueDoMouse() {// Procedimentos a serem executados a cada clique
        if (!this.isViradaPraFrente()) {// Verifica se a carta não esta virada para frente (atribui false)
            ...
            if (cont == 2) {// Verifica se o contador está em 2
                ...
                if (contCardViradaPar == 36) {//  Verifica se as 36 cartas ja estão viradas
